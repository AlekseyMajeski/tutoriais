...
add('responsive','home mantém navegação essencial no mobile',/@media\(max-width:620px\)[\s\S]*?home-topbar \.nav a:first-child\{display:inline-flex/.test(homeCss));
add('responsive','hubs tablet',/@media\(max-width:900px\)/.test(hubCss));
add('responsive','hubs mobile',/@media\(max-width:620px\)/.test(hubCss));
add('responsive','hubs mantêm navegação essencial no mobile',/@media\(max-width:620px\)[\s\S]*?hub-page \.topbar \.nav a:first-child\{display:inline-flex/.test(hubCss));
...
add('responsive','suporte mantém navegação essencial no mobile',/@media\(max-width:620px\)[\s\S]*?support-page \.topbar \.nav a:first-child\{display:inline-flex/.test(supportCss));
